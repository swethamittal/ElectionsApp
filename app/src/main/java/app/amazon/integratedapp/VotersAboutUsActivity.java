...
public class  VotersAboutUsActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {
    static TextView txt;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate( savedInstanceState );
        setContentView( R.layout.activity_voters_about_us );
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.hom) {
            ...
            intent.setClassName( VotersAboutUsActivity.this,"app.amazon.integratedapp.VoterProfileActivity");
            startActivity(intent);
        }else if (id == R.id.CL) {
            Intent intent=new Intent();
            intent.putExtra("AssemblyConstituency","*");
            intent.setClassName( VotersAboutUsActivity.this,"app.amazon.integratedapp.VoterCandidateListActivity");
            startActivity(intent);
        } else if (id == R.id.lo) {
            Intent intent=new Intent();
            intent.setFlags( Intent.FLAG_ACTIVITY_CLEAR_TOP );
            intent.putExtra( "EXIT",true );
            intent.setClassName( VotersAboutUsActivity.this,"app.amazon.integratedapp.LoginActivity");
            startActivity(intent);
        }
        else if(id ==R.id.Stats){
            Intent intent=new Intent( );
            intent.setClassName(  VotersAboutUsActivity.this,"app.amazon.integratedapp.VotersStatisticsIPAddressActivity" );
            startActivity(intent);
        }
        else if (id == R.id.abu) {
            Intent intent=new Intent();
            intent.setClassName( VotersAboutUsActivity.this,"app.amazon.integratedapp.VotersAboutUsActivity");
            startActivity(intent);
        }
        else if (id == R.id.prof) {
            Intent intent=new Intent();
            intent.setClassName( VotersAboutUsActivity.this,"app.amazon.integratedapp.VoterProfileInformationActivity");
            startActivity(intent);
        }

        else if (id == R.id.can) {
            Intent intent=new Intent();
            intent.setClassName( VotersAboutUsActivity.this,"app.amazon.integratedapp.CandidatePromisesActivity");
            startActivity(intent);
        }
        else if (id == R.id.rules) {
            Intent intent=new Intent();
            intent.setClassName( VotersAboutUsActivity.this,"app.amazon.integratedapp.VotersRulesActivity");
            startActivity(intent);
        }
